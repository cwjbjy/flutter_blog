...
class ShareArticleDialog extends StatelessWidget {
  ...
  ShareArticleDialog({super.key, required this.url});
  ...
  shareArticle() {
    ...
    RequestRepository.shareArticle(title, url, success: (data) {
